...
import os
os.environ["RUNTIME_ENV"] = os.environ.get("RUNTIME_ENV", "load")
_cfg = Config()
TOTAL_REQUESTS = getattr(_cfg.load_test, "total_requests", 100) if hasattr(_cfg, "load_test") else 100
CONCURRENT_CLIENTS = getattr(_cfg.load_test, "concurrent_clients", 10) if hasattr(_cfg, "load_test") else 10
