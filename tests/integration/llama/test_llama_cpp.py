...
async def test_llama_cpp_routing_load(query, expected_route, context_summary, shared_executor, session_config):
    """
    ...
    model_path = session_config.server.get_router("llama").model_path
    ...
    try:
        ...
        assert actual_route in [expected_route_val, "fallback"], f"LlamaCpp routed '{query}' to '{actual_route!r}' but expected '{expected_route_val!r}'"
