...
class Config:
    ...
    def get_env_file_name(fileName: str, env: str = None) -> str | None:
        ...
        env_to_use = env if env else os.environ.get(RUNTIME_ENV, 'local')
    ...
    def __init__(self, file: str = None):
        ...
        with open(file, "rb") as f:
            ...
            self.api_server = APIServer(data.get("server", data.get("api_server")))
    ...
    def load_overrides(self, env: str):
        ...
        if env_file_name is not None:
            with open(env_file_name, "rb") as f:
                ...
                if data.get("server") or data.get("api_server"):
                    self.api_server.updateValues(data.get("server", data.get("api_server")))
