# EdgeRouter - Common Package

The `common` package provides shared utilities, configuration management, and observability foundations for the EdgeRouter project.
