# EdgeRouter - llama.cpp Router Package

The `llama-cpp-router` package provides local LLM inference via the `llama-cpp-python` bindings. It is optimized for cross-platform support (macOS Apple Silicon and Linux CUDA).
